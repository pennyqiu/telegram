...
> ⚠️ 关键边界：申报的核心判定标准是「是否有现金价值」。无现金价值的纯保障类保单不申报。这意味着大部分内地客户买的港险（储蓄分红型）都需要申报。
...
> ⚠️ 关键事实：截至 2025 年，中国大陆税务机关对内地居民持有的香港保单普遍未启动主动征税程序。但 CRS 信息已经在交换中，未来政策风险存在。这不是「藏匿资产」的工具 — 你的现金价值数据已经在税务局电脑里。对于完全合规的客户，CRS 只是「信息透明化」，不构成新增税负。
