...
> **`playbooks/` 已于 2026-08-01 迁出**至 [`../美股持仓复盘/playbooks/`](../美股持仓复盘/playbooks/)。
> 那三份个股操作手册（QCOM / NVDA / DRAM）是投资决策文档，本模块的代码从未引用过它们；
> 放到复盘体系里，才能和标的档案、投资规则卡、决策日志形成闭环。
> 本模块只保留可执行的策略代码，投资逻辑与人工操作手册不再混放在这里。
